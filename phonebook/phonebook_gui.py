...
# be sure to import other modules to have access to them
...
def load_gui(self):
    ...
    self.lbl_fname.grd(row=0, column=0, padx=(27,0), pady=(10,0), sticky=N+W)
    ...
    self.1stList1.grid(row=1,column=2,rowspan=7,columnspan=3,pax=(0,0),pady=(0,0),sticky=N+E+S+W)
    ...
    self.btn_delete.grid(row=8,column=2,padx=(15,10),pady=(45,10),sticky=W)
